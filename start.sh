...
MODEL1_MAX_CONCURRENT_EFFECTIVE="${LMS_MODEL1_MAX_CONCURRENT:-${MAX_CONCURRENT_EFFECTIVE}}"
MODEL2_MAX_CONCURRENT_EFFECTIVE="${LMS_MODEL2_MAX_CONCURRENT:-${MAX_CONCURRENT_EFFECTIVE}}"
MODEL1_THREADS_EFFECTIVE="${LMS_MODEL1_THREADS:-${THREADS_EFFECTIVE}}"
MODEL2_THREADS_EFFECTIVE="${LMS_MODEL2_THREADS:-${THREADS_EFFECTIVE}}"
MODEL1_CTX_SIZE_EFFECTIVE="${LMS_MODEL1_CTX_SIZE:-${CTX_SIZE_EFFECTIVE}}"
MODEL2_CTX_SIZE_EFFECTIVE="${LMS_MODEL2_CTX_SIZE:-${CTX_SIZE_EFFECTIVE}}"
...
echo "        LMS_MODEL1_MAX_CONCURRENT=${MODEL1_MAX_CONCURRENT_EFFECTIVE}"
echo "        LMS_MODEL1_THREADS=${MODEL1_THREADS_EFFECTIVE}"
echo "        LMS_MODEL1_CTX_SIZE=${MODEL1_CTX_SIZE_EFFECTIVE}"
echo "        LMS_MODEL2_MAX_CONCURRENT=${MODEL2_MAX_CONCURRENT_EFFECTIVE}"
echo "        LMS_MODEL2_THREADS=${MODEL2_THREADS_EFFECTIVE}"
echo "        LMS_MODEL2_CTX_SIZE=${MODEL2_CTX_SIZE_EFFECTIVE}"
